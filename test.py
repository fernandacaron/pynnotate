...
def main():
    ...
    synonym_dict = {
        ...
        "tRNA-Leu": ["tRNA-Leu", "tRNA_Leu", "trnL", "trnL-uag", "trnL TAG", "tRNA-Leu (CUN)",
        ...
        "tRNA-Ser": ["tRNA-Ser", "tRNA_Ser", "trnS", "trnS-uga", "trnS GCT", "tRNA-Ser (UCN)",
                     "tRNA_Ser (AGY)", "tRNA-Ser(UCN)", "tRNA-Ser(AGY)"],
        "tRNA-Thr": ["tRNA-Thr", "tRNA_Thr", "trnT-ugu", "trnT TGT", "threonine tRNA"],
